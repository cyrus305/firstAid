 ...
 * @version 1.1
 * @link http://qussay.com/2013/09/28/handling-java-generic-types-with-
 * reflection
 * @since 2014-04-13
 */
public class ReflectionUtil {
   ...
   * @return a newly allocated instance of the class represented by the invoked
   * {@code Type} object.
   ...
   *
   * @param clazz the {@code Class} object whose declared fields to be checked for a
   *              certain field.
   ...
   *
   * @param clazz the {@code Class} object whose declared methods to be checked for
   *              the wanted method name.
   * @param name  the method name as {@code String} to be compared with
   *              {@link Method#getName()}
   * @return the {@code Class} object representing the return type of the given
   * method name.
  ...
  public static <T> Class<T> getClazz(Object object) throws ClassNotFoundException {
    Type[] parameterizedTypes = ReflectionUtil.getParameterizedTypes(object);
    return (Class<T>) ReflectionUtil.getClass(parameterizedTypes[0]);
  }
}